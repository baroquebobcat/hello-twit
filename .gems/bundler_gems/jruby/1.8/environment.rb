...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/sinatra-twitter-oauth-0.0.3/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/json-1.2.3/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/json-1.2.3/ext/json/ext")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/json-1.2.3/ext")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/json-1.2.3/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/jruby-openssl-0.6.1/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rack-1.1.0/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rack-1.1.0/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/sinatra-0.9.6/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/mime-types-1.16/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/ruby-hmac-0.4.0/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/appengine-apis-0.0.12/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/appengine-jruby-jars-0.0.7.pre/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/twitter_oauth-0.3.3/lib")
